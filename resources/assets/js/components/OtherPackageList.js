...
class OtherProjectList extends Component {
      ...
      return (
        <div className="flex flex-col mb-4" key={item.id} >
          ...
          <div className="flex mt-4 items-center">
            <div className="language text-xs pr-4 text-grey-darker flex">
  ...
  render () {
    const packageList = this.generateOtherProjectList();
